...
int main()
{
    ...
    if ((Can1 == "")||(Can1 == " "))
    {
        cout << "Não é permitido campo em branco!" << endl;
    }
    } while ((Can1 == "")||(Can1 == " "));
    do
    {
    ...
    cout << "Candidato 1   Votos : " << Cont  << "     Nao votariam : " << NV1 << "\tPorcentagem dos votos : " << (Cont*100)/Ent  << "%"  << "\tAceitação : " << A <<  "%" << "  \tRejeição : " << R <<   "%" << endl;
    cout << "Candidato 2   Votos : " << Cont2 << "     Nao votariam : " << NV2 << "\tPorcentagem dos votos : " << (Cont2*100)/Ent << "%"  << "\tAceitação : " << A2 << "%" << "  \tRejeição : " << R2 <<  "%" << endl;
    cout << "Candidato 3   Votos : " << Cont3 << "     Nao votariam : " << NV3 << "\tPorcentagem dos votos : " << (Cont3*100)/Ent << "%"  << "\tAceitação : " << A3 << "%" << "  \tRejeição : " << R3 <<  "%" << endl;
    cout << "Candidato 4   Votos : " << Cont4 << "     Nao votariam : " << NV4 << "\tPorcentagem dos votos : " << (Cont4*100)/Ent << "%"  << "\tAceitação : " << A4 << "%" << "  \tRejeição : " << R4 <<  "%" << endl;
    cout << "Candidato 5   Votos : " << Cont5 << "     Nao votariam : " << NV5 << "\tPorcentagem dos votos : " << (Cont5*100)/Ent << "%"  << "\tAceitação : " << A5 << "%" << "  \tRejeição : " << R5 <<  "%" << endl;
    cout << " Indeciso           : " << Cont6 << "     Sem opnião   : " << NV6 << "\tPorcentagem de indecisos : " << Ind << "%" << endl;
